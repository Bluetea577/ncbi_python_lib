...
class TestV2reportsGenomeAnnotationReportMatch(unittest.TestCase):
    """V2reportsGenomeAnnotationReportMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsGenomeAnnotationReportMatch:
        """Test V2reportsGenomeAnnotationReportMatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsGenomeAnnotationReportMatch`
        """
        model = V2reportsGenomeAnnotationReportMatch()
        if include_optional:
            return V2reportsGenomeAnnotationReportMatch(
    ...
    def testV2reportsGenomeAnnotationReportMatch(self):
        """Test V2reportsGenomeAnnotationReportMatch"""
