...
class TestV2reportsTaxonomyNamesReportMatch(unittest.TestCase):
    """V2reportsTaxonomyNamesReportMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsTaxonomyNamesReportMatch:
        """Test V2reportsTaxonomyNamesReportMatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsTaxonomyNamesReportMatch`
        """
        model = V2reportsTaxonomyNamesReportMatch()
        if include_optional:
            return V2reportsTaxonomyNamesReportMatch(
    ...
    def testV2reportsTaxonomyNamesReportMatch(self):
        """Test V2reportsTaxonomyNamesReportMatch"""
