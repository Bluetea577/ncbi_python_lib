...
class TestV2reportsTaxonomyDataReportPage(unittest.TestCase):
    """V2reportsTaxonomyDataReportPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsTaxonomyDataReportPage:
        """Test V2reportsTaxonomyDataReportPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsTaxonomyDataReportPage`
        """
        model = V2reportsTaxonomyDataReportPage()
        if include_optional:
            return V2reportsTaxonomyDataReportPage(
                reports = [
                    ncbi.datasets.openapi.models.v2reports_taxonomy_report_match.v2reportsTaxonomyReportMatch(
    ...
    def testV2reportsTaxonomyDataReportPage(self):
        """Test V2reportsTaxonomyDataReportPage"""
