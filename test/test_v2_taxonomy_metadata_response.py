...
class TestV2TaxonomyMetadataResponse(unittest.TestCase):
    """V2TaxonomyMetadataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2TaxonomyMetadataResponse:
        """Test V2TaxonomyMetadataResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2TaxonomyMetadataResponse`
        """
        model = V2TaxonomyMetadataResponse()
        if include_optional:
            return V2TaxonomyMetadataResponse(
                ...
                taxonomy_nodes = [
                    ncbi.datasets.openapi.models.v2_taxonomy_match.v2TaxonomyMatch(
                        warnings = [
    ...
    def testV2TaxonomyMetadataResponse(self):
        """Test V2TaxonomyMetadataResponse"""
