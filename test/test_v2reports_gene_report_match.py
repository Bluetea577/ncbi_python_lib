...
class TestV2reportsGeneReportMatch(unittest.TestCase):
    """V2reportsGeneReportMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsGeneReportMatch:
        """Test V2reportsGeneReportMatch
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsGeneReportMatch`
        """
        model = V2reportsGeneReportMatch()
        if include_optional:
            return V2reportsGeneReportMatch(
    ...
    def testV2reportsGeneReportMatch(self):
        """Test V2reportsGeneReportMatch"""
