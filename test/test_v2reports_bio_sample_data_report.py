...
class TestV2reportsBioSampleDataReport(unittest.TestCase):
    """V2reportsBioSampleDataReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsBioSampleDataReport:
        """Test V2reportsBioSampleDataReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsBioSampleDataReport`
        """
        model = V2reportsBioSampleDataReport()
        if include_optional:
            return V2reportsBioSampleDataReport(
                accession = '',
                last_updated = '',
                publication_date = '',
                submission_date = '',
    ...
    def testV2reportsBioSampleDataReport(self):
        """Test V2reportsBioSampleDataReport"""
