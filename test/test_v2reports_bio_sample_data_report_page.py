...
class TestV2reportsBioSampleDataReportPage(unittest.TestCase):
    """V2reportsBioSampleDataReportPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2reportsBioSampleDataReportPage:
        """Test V2reportsBioSampleDataReportPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2reportsBioSampleDataReportPage`
        """
        model = V2reportsBioSampleDataReportPage()
        if include_optional:
            return V2reportsBioSampleDataReportPage(
                reports = [
                    ncbi.datasets.openapi.models.v2reports_bio_sample_data_report.v2reportsBioSampleDataReport(
                        accession = '', 
                        last_updated = '', 
                        publication_date = '', 
                        submission_date = '', 
    ...
    def testV2reportsBioSampleDataReportPage(self):
        """Test V2reportsBioSampleDataReportPage"""
