...
class V2GeneCountsByTaxonReply(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "report": [V2GeneCountsByTaxonReplyGeneTypeAndCount.from_dict(_item) for _item in obj.get("report")] if obj.get("report") is not None else None
        })
        return _obj
