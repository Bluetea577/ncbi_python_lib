...
class V2reportsAssemblyInfo(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.bioproject_lineage:
            for _item in self.bioproject_lineage:
                if _item:
        ...
        if self.linked_assemblies:
            for _item in self.linked_assemblies:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "paired_assembly": V2reportsPairedAssembly.from_dict(obj.get("paired_assembly")) if obj.get("paired_assembly") is not None else None,
            "assembly_name": obj.get("assembly_name"),
            "assembly_long_name": obj.get("assembly_long_name"),
            "assembly_type": obj.get("assembly_type"),
            "bioproject_lineage": [V2reportsBioProjectLineage.from_dict(_item) for _item in obj.get("bioproject_lineage")] if obj.get("bioproject_lineage") is not None else None,
            ...
            "linked_assemblies": [V2reportsLinkedAssembly.from_dict(_item) for _item in obj.get("linked_assemblies")] if obj.get("linked_assemblies") is not None else None,
            "atypical": V2reportsAtypicalInfo.from_dict(obj.get("atypical")) if obj.get("atypical") is not None else None,
            ...
            "biosample": V2reportsBioSampleDescriptor.from_dict(obj.get("biosample")) if obj.get("biosample") is not None else None,
