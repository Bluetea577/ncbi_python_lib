...
class V2AssemblyDatasetReportsRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "filters": V2AssemblyDatasetDescriptorsFilter.from_dict(obj.get("filters")) if obj.get("filters") is not None else None,
            ...
            "sort": [V2SortField.from_dict(_item) for _item in obj.get("sort")] if obj.get("sort") is not None else None,
