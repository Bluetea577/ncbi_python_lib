...
class V2reportsVirusPeptide(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.mature_peptide:
            for _item in self.mature_peptide:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "protein": V2reportsSeqRangeSetFasta.from_dict(obj.get("protein")) if obj.get("protein") is not None else None,
            "pdb_ids": obj.get("pdb_ids"),
            "cdd": [V2reportsConservedDomain.from_dict(_item) for _item in obj.get("cdd")] if obj.get("cdd") is not None else None,
            "uni_prot_kb": V2reportsVirusPeptideUniProtId.from_dict(obj.get("uni_prot_kb")) if obj.get("uni_prot_kb") is not None else None,
            "mature_peptide": [V2reportsVirusPeptide.from_dict(_item) for _item in obj.get("mature_peptide")] if obj.get("mature_peptide") is not None else None,
