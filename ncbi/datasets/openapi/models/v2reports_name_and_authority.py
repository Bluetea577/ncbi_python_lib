...
class V2reportsNameAndAuthority(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.type_strains:
            for _item in self.type_strains:
                if _item:
        ...
        if self.homotypic_synonyms:
            for _item in self.homotypic_synonyms:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.heterotypic_synonyms:
            for _item in self.heterotypic_synonyms:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.other_synonyms:
            for _item in self.other_synonyms:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "type_strains": [V2reportsTaxonomyTypeMaterial.from_dict(_item) for _item in obj.get("type_strains")] if obj.get("type_strains") is not None else None,
            "curator_synonym": obj.get("curator_synonym"),
            "homotypic_synonyms": [V2reportsNameAndAuthority.from_dict(_item) for _item in obj.get("homotypic_synonyms")] if obj.get("homotypic_synonyms") is not None else None,
            "heterotypic_synonyms": [V2reportsNameAndAuthority.from_dict(_item) for _item in obj.get("heterotypic_synonyms")] if obj.get("heterotypic_synonyms") is not None else None,
            "other_synonyms": [V2reportsNameAndAuthority.from_dict(_item) for _item in obj.get("other_synonyms")] if obj.get("other_synonyms") is not None else None,
            "informal_names": obj.get("informal_names"),
            "basionym": V2reportsNameAndAuthority.from_dict(obj.get("basionym")) if obj.get("basionym") is not None else None,
            "publications": [V2reportsNameAndAuthorityPublication.from_dict(_item) for _item in obj.get("publications")] if obj.get("publications") is not None else None,
            "notes": [V2reportsNameAndAuthorityNote.from_dict(_item) for _item in obj.get("notes")] if obj.get("notes") is not None else None,
