...
class V2reportsOrganelle(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "genbank": V2reportsSequenceInformation.from_dict(obj.get("genbank")) if obj.get("genbank") is not None else None,
            "refseq": V2reportsSequenceInformation.from_dict(obj.get("refseq")) if obj.get("refseq") is not None else None,
            ...
            "biosample": V2reportsOrganelleBiosample.from_dict(obj.get("biosample")) if obj.get("biosample") is not None else None,
            "gene_counts": V2reportsOrganelleGeneCounts.from_dict(obj.get("gene_counts")) if obj.get("gene_counts") is not None else None,
