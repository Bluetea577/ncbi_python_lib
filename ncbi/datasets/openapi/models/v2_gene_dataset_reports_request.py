...
class V2GeneDatasetReportsRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["returned_content", "gene_ids", "accessions", "symbols_for_taxon", "taxon", "table_fields", "table_format", "include_tabular_header", "page_size", "page_token", "query", "types"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "symbols_for_taxon": V2GeneDatasetReportsRequestSymbolsForTaxon.from_dict(obj.get("symbols_for_taxon")) if obj.get("symbols_for_taxon") is not None else None,
            "taxon": obj.get("taxon"),
