...
class V2AssemblyCheckMHistogramReply(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "histogram_intervals": [V2AssemblyCheckMHistogramReplyHistogramInterval.from_dict(_item) for _item in obj.get("histogram_intervals")] if obj.get("histogram_intervals") is not None else None
        })
        return _obj
