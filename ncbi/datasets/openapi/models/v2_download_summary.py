...
class V2DownloadSummary(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "hydrated": V2DownloadSummaryHydrated.from_dict(obj.get("hydrated")) if obj.get("hydrated") is not None else None,
            "dehydrated": V2DownloadSummaryDehydrated.from_dict(obj.get("dehydrated")) if obj.get("dehydrated") is not None else None,
            "errors": [V2reportsError.from_dict(_item) for _item in obj.get("errors")] if obj.get("errors") is not None else None,
            "messages": [V2reportsMessage.from_dict(_item) for _item in obj.get("messages")] if obj.get("messages") is not None else None,
            "available_files": V2DownloadSummaryAvailableFiles.from_dict(obj.get("available_files")) if obj.get("available_files") is not None else None
        })
        return _obj
