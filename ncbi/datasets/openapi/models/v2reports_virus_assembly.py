...
class V2reportsVirusAssembly(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "isolate": V2reportsIsolate.from_dict(obj.get("isolate")) if obj.get("isolate") is not None else None,
            "source_database": obj.get("source_database"),
            "protein_count": obj.get("protein_count"),
            "host": V2reportsOrganism.from_dict(obj.get("host")) if obj.get("host") is not None else None,
            "virus": V2reportsOrganism.from_dict(obj.get("virus")) if obj.get("virus") is not None else None,
            "bioprojects": obj.get("bioprojects"),
            "location": V2reportsVirusAssemblyCollectionLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
            ...
            "nucleotide": V2reportsSeqRangeSetFasta.from_dict(obj.get("nucleotide")) if obj.get("nucleotide") is not None else None,
            "purpose_of_sampling": obj.get("purpose_of_sampling"),
            "sra_accessions": obj.get("sra_accessions"),
            "submitter": V2reportsVirusAssemblySubmitterInfo.from_dict(obj.get("submitter")) if obj.get("submitter") is not None else None,
