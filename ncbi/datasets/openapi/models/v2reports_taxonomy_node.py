...
class V2reportsTaxonomyNode(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tax_id", "rank", "current_scientific_name", "basionym", "curator_common_name", "group_name", "has_type_material", "classification", "parents", "children", "counts", "genomic_moltype"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "rank": obj.get("rank"),
            "current_scientific_name": V2reportsNameAndAuthority.from_dict(obj.get("current_scientific_name")) if obj.get("current_scientific_name") is not None else None,
            ...
            "classification": V2reportsClassification.from_dict(obj.get("classification")) if obj.get("classification") is not None else None,
            "parents": obj.get("parents"),
            "children": obj.get("children"),
            "counts": [V2reportsTaxonomyNodeCountByType.from_dict(_item) for _item in obj.get("counts")] if obj.get("counts") is not None else None,
