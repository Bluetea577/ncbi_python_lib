...
class V2DownloadSummaryAvailableFiles(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "all_genomic_fasta": V2DownloadSummaryFileSummary.from_dict(obj.get("all_genomic_fasta")) if obj.get("all_genomic_fasta") is not None else None,
            "genome_gff": V2DownloadSummaryFileSummary.from_dict(obj.get("genome_gff")) if obj.get("genome_gff") is not None else None,
            "genome_gbff": V2DownloadSummaryFileSummary.from_dict(obj.get("genome_gbff")) if obj.get("genome_gbff") is not None else None,
            "rna_fasta": V2DownloadSummaryFileSummary.from_dict(obj.get("rna_fasta")) if obj.get("rna_fasta") is not None else None,
            "prot_fasta": V2DownloadSummaryFileSummary.from_dict(obj.get("prot_fasta")) if obj.get("prot_fasta") is not None else None,
            "genome_gtf": V2DownloadSummaryFileSummary.from_dict(obj.get("genome_gtf")) if obj.get("genome_gtf") is not None else None,
            "cds_fasta": V2DownloadSummaryFileSummary.from_dict(obj.get("cds_fasta")) if obj.get("cds_fasta") is not None else None,
            "sequence_report": V2DownloadSummaryFileSummary.from_dict(obj.get("sequence_report")) if obj.get("sequence_report") is not None else None,
            "annotation_report": V2DownloadSummaryFileSummary.from_dict(obj.get("annotation_report")) if obj.get("annotation_report") is not None else None
        })
        return _obj
