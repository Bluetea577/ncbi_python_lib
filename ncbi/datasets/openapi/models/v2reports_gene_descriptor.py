...
class V2reportsGeneDescriptor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["gene_id", "symbol", "description", "tax_id", "taxname", "common_name", "type", "rna_type", "orientation", "reference_standards", "genomic_regions", "chromosomes", "nomenclature_authority", "swiss_prot_accessions", "ensembl_gene_ids", "omim_ids", "synonyms", "replaced_gene_id", "annotations", "transcript_count", "protein_count", "transcript_type_counts", "gene_groups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.reference_standards:
            for _item in self.reference_standards:
                if _item:
        ...
        if self.genomic_regions:
            for _item in self.genomic_regions:
                if _item:
                    _items.append(_item.to_dict())
        ...
        if self.transcript_type_counts:
            for _item in self.transcript_type_counts:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "reference_standards": [V2reportsGenomicRegion.from_dict(_item) for _item in obj.get("reference_standards")] if obj.get("reference_standards") is not None else None,
            "genomic_regions": [V2reportsGenomicRegion.from_dict(_item) for _item in obj.get("genomic_regions")] if obj.get("genomic_regions") is not None else None,
            "chromosomes": obj.get("chromosomes"),
            "nomenclature_authority": V2reportsNomenclatureAuthority.from_dict(obj.get("nomenclature_authority")) if obj.get("nomenclature_authority") is not None else None,
            ...
            "annotations": [V2reportsAnnotation.from_dict(_item) for _item in obj.get("annotations")] if obj.get("annotations") is not None else None,
            "transcript_count": obj.get("transcript_count"),
            "protein_count": obj.get("protein_count"),
            "transcript_type_counts": [V2reportsTranscriptTypeCount.from_dict(_item) for _item in obj.get("transcript_type_counts")] if obj.get("transcript_type_counts") is not None else None,
            "gene_groups": [V2reportsGeneGroup.from_dict(_item) for _item in obj.get("gene_groups")] if obj.get("gene_groups") is not None else None
        })
        return _obj
