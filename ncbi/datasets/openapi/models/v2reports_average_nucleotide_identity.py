...
class V2reportsAverageNucleotideIdentity(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "submitted_ani_match": V2reportsANIMatch.from_dict(obj.get("submitted_ani_match")) if obj.get("submitted_ani_match") is not None else None,
            "best_ani_match": V2reportsANIMatch.from_dict(obj.get("best_ani_match")) if obj.get("best_ani_match") is not None else None,
