...
class V2reportsAnnotationInfo(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stats": V2reportsFeatureCounts.from_dict(obj.get("stats")) if obj.get("stats") is not None else None,
            "busco": V2reportsBuscoStat.from_dict(obj.get("busco")) if obj.get("busco") is not None else None,
