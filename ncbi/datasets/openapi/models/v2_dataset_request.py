...
class V2DatasetRequest(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "genome_v2": V2AssemblyDatasetRequest.from_dict(obj.get("genome_v2")) if obj.get("genome_v2") is not None else None,
            "gene_v2": V2GeneDatasetRequest.from_dict(obj.get("gene_v2")) if obj.get("gene_v2") is not None else None,
            "virus_v2": V2VirusDatasetRequest.from_dict(obj.get("virus_v2")) if obj.get("virus_v2") is not None else None
        })
        return _obj
