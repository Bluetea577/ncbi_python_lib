...
class V2reportsGenomeAnnotation(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "transcripts": [V2reportsTranscript.from_dict(_item) for _item in obj.get("transcripts")] if obj.get("transcripts") is not None else None,
            "proteins": [V2reportsProtein.from_dict(_item) for _item in obj.get("proteins")] if obj.get("proteins") is not None else None,
