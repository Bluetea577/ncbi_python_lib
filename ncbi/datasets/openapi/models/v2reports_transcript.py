...
class V2reportsTranscript(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accession_version", "name", "length", "cds", "genomic_locations", "ensembl_transcript", "protein", "type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.genomic_locations:
            for _item in self.genomic_locations:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "cds": V2reportsSeqRangeSet.from_dict(obj.get("cds")) if obj.get("cds") is not None else None,
            "genomic_locations": [V2reportsGenomicLocation.from_dict(_item) for _item in obj.get("genomic_locations")] if obj.get("genomic_locations") is not None else None,
            "ensembl_transcript": obj.get("ensembl_transcript"),
            "protein": V2reportsProtein.from_dict(obj.get("protein")) if obj.get("protein") is not None else None,
            "type": obj.get("type")
        })
        return _obj
