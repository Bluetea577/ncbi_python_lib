...
class V2TaxonomyLinksResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.generic_links:
            for _item in self.generic_links:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "generic_links": [V2TaxonomyLinksResponseGenericLink.from_dict(_item) for _item in obj.get("generic_links")] if obj.get("generic_links") is not None else None
        })
        return _obj
