...
class V2reportsGeneReportMatch(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "gene": V2reportsGeneDescriptor.from_dict(obj.get("gene")) if obj.get("gene") is not None else None,
            "product": V2reportsProductDescriptor.from_dict(obj.get("product")) if obj.get("product") is not None else None,
            "query": obj.get("query"),
            "warnings": [V2reportsWarning.from_dict(_item) for _item in obj.get("warnings")] if obj.get("warnings") is not None else None,
            "warning": V2reportsWarning.from_dict(obj.get("warning")) if obj.get("warning") is not None else None,
