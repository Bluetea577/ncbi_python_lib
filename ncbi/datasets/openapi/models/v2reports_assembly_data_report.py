...
class V2reportsAssemblyDataReport(BaseModel):
    ...
    additional_submitters: Optional[List[V2reportsExtraSequenceInfo]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.additional_submitters:
            for _item in self.additional_submitters:
                if _item:
                    _items.append(_item.to_dict())
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "organism": V2reportsOrganism.from_dict(obj.get("organism")) if obj.get("organism") is not None else None,
            "assembly_info": V2reportsAssemblyInfo.from_dict(obj.get("assembly_info")) if obj.get("assembly_info") is not None else None,
            "assembly_stats": V2reportsAssemblyStats.from_dict(obj.get("assembly_stats")) if obj.get("assembly_stats") is not None else None,
            "organelle_info": [V2reportsOrganelleInfo.from_dict(_item) for _item in obj.get("organelle_info")] if obj.get("organelle_info") is not None else None,
            "additional_submitters": [V2reportsExtraSequenceInfo.from_dict(_item) for _item in obj.get("additional_submitters")] if obj.get("additional_submitters") is not None else None,
            "annotation_info": V2reportsAnnotationInfo.from_dict(obj.get("annotation_info")) if obj.get("annotation_info") is not None else None,
            "wgs_info": V2reportsWGSInfo.from_dict(obj.get("wgs_info")) if obj.get("wgs_info") is not None else None,
            "type_material": V2reportsTypeMaterial.from_dict(obj.get("type_material")) if obj.get("type_material") is not None else None,
            "checkm_info": V2reportsCheckM.from_dict(obj.get("checkm_info")) if obj.get("checkm_info") is not None else None,
            "average_nucleotide_identity": V2reportsAverageNucleotideIdentity.from_dict(obj.get("average_nucleotide_identity")) if obj.get("average_nucleotide_identity") is not None else None
        })
        return _obj
