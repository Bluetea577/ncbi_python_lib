...
class V2reportsOrganism(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lineage": [V2reportsLineageOrganism.from_dict(_item) for _item in obj.get("lineage")] if obj.get("lineage") is not None else None,
            "strain": obj.get("strain"),
            "pangolin_classification": obj.get("pangolin_classification"),
            "infraspecific_names": V2reportsInfraspecificNames.from_dict(obj.get("infraspecific_names")) if obj.get("infraspecific_names") is not None else None
        })
        return _obj
