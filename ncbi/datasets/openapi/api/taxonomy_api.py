...
class TaxonomyApi:
    ...
    def taxonomy_related_ids(
        ...
        include_subtree: Annotated[Optional[StrictBool], Field(description="If true, return reports for all taxonomy nodes that are children of the requested tax_ids")] = None,
        ranks: Annotated[Optional[List[V2reportsRankType]], Field(description="Only include taxons of the provided ranks. If empty, return all ranks.")] = None,
        ...
        :param include_subtree: If true, return reports for all taxonomy nodes that are children of the requested tax_ids
